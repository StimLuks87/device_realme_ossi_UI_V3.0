...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
	...
	export TARGET_DEVICE_ALT="RMX2151,RMX2155,RMX2156,RMX2151L1,RMX2155L1,RMX2156L1,oppo6785,RM6785,salaa,ossi"
	...
	export OF_PATCH_AVB20=1
        ...
        export FOX_USE_SPECIFIC_MAGISK_ZIP="/home/stim/OrangeFox/fox_12.1/device/oplus/ossi/Magisk/Magisk-v26.4.zip"
